...
<body>
    ...
    <div id="header-bg" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/about-big.jpg" style="width: 100%;">
                <div class="carousel-shadow">
                    <span class="carousel-shadow-title">
                        Who we are <br>
                        Collaborators<br>
                        Friends<br>
                        A Family
    ...
    <div class="container-fluid app-main">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 content-title">What we do</div>
                <div class="col-sm-12 content-what">We will bring to our customers the greatest experience in travelling</div>
            </div>
            <div class="row" style="margin-top: 20px;">
                <div class="col-sm-6 content-item text-center">
                    <div class="content-item-wrap">
                        <video width="100%" height="100%" controls>
                            <source src="videos/biendao.mp4" type="video/mp4">
                        </video>
                        <div class="content-video-details">
                            <div class="content-video-title">
                                More Information
                            </div>
                            <div class="content-video-details">
                                Beautiful scenery, Good weather, Good service<br> Considering every customer is a partner
                            </div>
                            <div class="content-video-slogan">
                                <i>"A place for happiness and experiences"</i>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 content-item text-center">
                    <div class="content-item-wrap">
                        <video width="100%" height="100%" controls>
                            <source src="videos/dung.mp4" type="video/mp4">
                        </video>
                        <div class="content-video-title">
                            How To Use 
                        </div>
                        <div class="content-video-details">
                            Helping people in work and life<br> Every employee is a member of family
                        </div>
                        <div class="content-video-slogan">
                            <i>"We make the differences"</i>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 content-title">How we work</div>
                <div class="col-sm-12 content-what">Small teams working on a big challenges in honest collaboration with our customers</div>
            </div>
            <div class="row">
                <div class="content-how-wrap">
                    <div class="col-sm-4 content-how-left">
                        Small Teams
                    </div>
                    <div class="col-sm-4 content-how-center">
                        <img src="images/team1.gif" class="content-how-img">
                    </div>
                    <div class="col-sm-4 content-how-right">
                        <ul>
                            <li>Every team deals with big ideas</li>
                            <li>Create the services which are suitable for customers</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="content-how-wrap">
                    <div class="col-sm-4 content-how-left">
                        Every customer <br> Every partner
                    </div>
                    <div class="col-sm-4 content-how-center">
                        <img src="images/shake-hand.png" class="content-how-img">
                    </div>
                    <div class="col-sm-4 content-how-right">
                        <ul>
                            <li>Customers gives their opinions and feedback to us</li>
            ...
            <div class="row">
                <div class="col-sm-12 content-title">Leadership</div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="row leadership-item">
                        <div class="col-sm-5 leadership-img-wrap">
                            <img src="images/leader2.jpg" alt="" class="leadership-img">
                        </div>
                        <div class="col-sm-7">
                            <div class="leadership-name">Hoàng Lê Dung</div>
                            <div class="leadership-position">Người thực hiện dự án</div>
                            <div class="leadship-contact">
                                <a href="#">
                                    <i class="leader-icon fab fa-facebook-square"></i>
                                </a>
                                <a href="#">
                                    <i class="leader-icon fab fa-twitter-square"></i>
                                </a>
                                <a href="#">
                                    <i class="leader-icon fab fa-instagram-square"></i>
                                </a>
                            </div>
                            <div class="leadship-details">
                                Co-Founder and Creative Director with 3 years in travelling. Inspired and motivated on a daily basic to help brands grow.
                            </div>
                            <div class="leadship-university">
                                <i class="fas fa-graduation-cap"></i> THPT Trần Quốc Tuấn
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center explore-btn-wrap">
                    <a href="details.php">
                        <button class="btn-explore">Explore our services</button>
                    </a>
                </div>
            </div>
        </div>
