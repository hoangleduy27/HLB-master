...
<head>
    ...
    <title>HẠ LONG - ĐẢO CÁC BÀ</title>
    ...
    <div class="navbar-wrap container-fluid">
        ...
        <div class="mobile-menu">
            <div class="mobile-menu-item">
                <a href="index.html" class="mobile-item__link">Home</a>
            </div>
            <div class="mobile-menu-item">
                <a href="details.html" class="mobile-item__link">Details</a>
            </div>
            <div class="mobile-menu-item">
                <a href="about.html" class="mobile-item__link">About</a>
            </div>
            <div class="mobile-menu-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-9 main-header-left">
                    <div class="row">
                        <div class="col-sm-7">
                            <img src="images/detail1.jpg" class="left-img">
                        </div>
                        <div class="col-sm-5">
                            ...
                            <div class="detail-infor">
                                Departure day: Everyday</br>
                                Time: 2 days 1 night</br>
                                Destination: HẠ LONG – ĐẢO CÁT BÀ
                            </div>
                ...
                <div class="col-sm-3 main-header-right">
                    <div class="right-wrap">
                        <div class="right-infor">
                            Select dates and number of guests to book tour.
                        </div>
                        <div class="form-group">
                            <label for="checkin">Check-in</label>
                            <input type="date" class="form-control" id="checkin" placeholder="Check-in" min="2020-06-01" max="2030-12-31">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="details-program">
                        ...
                        <div class="details-program-content">
                            <div class="program-content-title text-center">
                                <b>Tourism Program: HẠ LONG - ĐẢO CÁT BÀ</b></br>
                                Time: 2 days 1 night
                            </div>
                            <div class="program-content">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis at sollicitudin justo. Aenean fermentum, odio eget semper dignissim, lectus erat posuere tortor, sit amet volutpat erat elit sed tortor. In nec ex tortor. Aenean finibus nec libero in efficitur.
                                Mauris ullamcorper a nulla vitae venenatis. Aenean bibendum pulvinar pharetra. Donec sollicitudin elit scelerisque, venenatis nisi eget, vestibulum nibh. Pellentesque ac interdum odio. Nunc mattis justo vel iaculis convallis. Fusce mauris tellus, laoreet eget neque ut, suscipit consectetur metus. Morbi ut mauris sodales, dictum felis ac, dapibus risus. Suspendisse ut tincidunt enim. Praesent sollicitudin magna sed gravida consequat. Etiam vel ligula velit. Donec condimentum nisl sed dolor tristique fermentum. Ut ut aliquam urna.
                                In accumsan velit ut mauris hendrerit cursus. Ut nulla magna, bibendum eu egestas nec, finibus ac urna. Curabitur mattis lorem at posuere tempor. Mauris ut euismod felis, ac feugiat nibh. Nulla finibus cursus dictum. Praesent lobortis consectetur dolor ac accumsan. Mauris rhoncus libero eu neque fermentum, tincidunt iaculis nisi imperdiet. Pellentesque ac sapien hendrerit, laoreet nulla a, venenatis felis. Fusce cursus vel mi et aliquam. Mauris maximus sagittis metus. Etiam eu malesuada turpis. Cras egestas posuere finibus. Mauris at ipsum lacus. Donec posuere feugiat lectus euismod laoreet. Vivamus lacinia mauris et ante tincidunt, a facilisis mauris tristique. Aliquam sit amet consequat sapien, ut tristique libero.
                                <br><br>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis at sollicitudin justo. Aenean fermentum, odio eget semper dignissim, lectus erat posuere tortor, sit amet volutpat erat elit sed tortor. In nec ex tortor. Aenean finibus nec libero in efficitur.
                                Mauris ullamcorper a nulla vitae venenatis. Aenean bibendum pulvinar pharetra. Donec sollicitudin elit scelerisque, venenatis nisi eget, vestibulum nibh. Pellentesque ac interdum odio. Nunc mattis justo vel iaculis convallis. Fusce mauris tellus, laoreet eget neque ut, suscipit consectetur metus. Morbi ut mauris sodales, dictum felis ac, dapibus risus. Suspendisse ut tincidunt enim. Praesent sollicitudin magna sed gravida consequat. Etiam vel ligula velit. Donec condimentum nisl sed dolor tristique fermentum. Ut ut aliquam urna.
                                In accumsan velit ut mauris hendrerit cursus. Ut nulla magna, bibendum eu egestas nec, finibus ac urna. Curabitur mattis lorem at posuere tempor. Mauris ut euismod felis, ac feugiat nibh. Nulla finibus cursus dictum. Praesent lobortis consectetur dolor ac accumsan. Mauris rhoncus libero eu neque fermentum, tincidunt iaculis nisi imperdiet. Pellentesque ac sapien hendrerit, laoreet nulla a, venenatis felis. Fusce cursus vel mi et aliquam. Mauris maximus sagittis metus. Etiam eu malesuada turpis. Cras egestas posuere finibus. Mauris at ipsum lacus. Donec posuere feugiat lectus euismod laoreet. Vivamus lacinia mauris et ante tincidunt, a facilisis mauris tristique. Aliquam sit amet consequat sapien, ut tristique libero.
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    ...
                    <ul class="footer-list">
                        ...
                        <li class="footer-item">
                            <i class="far fa-envelope"></i> hoangleduy27901@gmail.com
                        </li>
                        <li class="footer-item">
